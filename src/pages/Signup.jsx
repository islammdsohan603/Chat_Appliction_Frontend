        ...
        >
          ...
          <div className="text-center text-sm text-slate-500 dark:text-slate-400/60 relative">
            ...
            <Link
              to="/login"
              className={[
                "text-purple-600 dark:text-purple-400 no-underline font-semibold transition-colors duration-300",
                ...
                "after:bg-gradient-to-r after:from-purple-500 after:to-cyan-500",
